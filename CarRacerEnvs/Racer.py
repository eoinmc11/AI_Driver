...
class CarRacing(gym.Env, EzPickle):
    ...
    def reset(self):
        ...
        return self.step(None, True)[0]

    def step(self, action, on_track):  # Added extra parameter to check if car has left the track
        off_track_deduction = -10
