...
from v3_PER_D3QN.StateHandling import PreProcess as Pp
...
class CarRacing(gym.Env, EzPickle):
    ...
    def step(self, action):  # Added extra parameter to check if car has left the track
        ...
        self.state = Pp.state_process(self.render("state_pixels"))
        ...
        if action is not None:  # First step without action, called from reset()
            ...
            if not Pp.on_track_detection(self.state) and self.track_steps > 20:
                done = True
